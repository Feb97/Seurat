...
# Load dataset
patient.data <- Read10X(data.dir = "/home/nicola/Scrivania/DATASET_HOMO/PATIENT_2")
...
patient.data[c("ACE2", "TMPRSS2", "GNG8", "GNG13", "KRT5", "CYP2A13"), 1:30]
...
VlnPlot(patient, features = c("ACE2", "TMPRSS2", "GNG8", "GNG13", "KRT5", "CYP2A13"))

# you can plot raw counts as well
VlnPlot(patient, features = c("ACE2", "TMPRSS2", "GNG8", "GNG13", "KRT5", "CYP2A13"), slot = "counts", log = TRUE)

#important UMAP!!!!!!!!!
FeaturePlot(patient, features = c("ACE2", "TMPRSS2", "GNG8", "GNG13", "KRT5", "CYP2A13"))
...
saveRDS(patient, file = "/home/nicola/Scrivania/DATASET_HOMO/PATIENT_2/final.rds")
